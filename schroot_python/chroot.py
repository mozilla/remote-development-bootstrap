...
from .errors import SchrootError
...
class SchrootChroot(object):
    ...
    def _command_prefix(self, user, dir, preserve_environment):
    ...
    def _command(self, cmd, kwargs):
        ...
        command = self._command_prefix(user, dir, preserve_environment)
        ...
        with NamedTemporaryFile(dir=tmp_dir, mode='w+t') as tmp_file:
